 ...
 * for example if user selects type uppercase 'u' and special 's' characters,
 * ParseCharCombinations() will return 0b1001
 * This function then returns the following array: {0b1000, 0b0001}
...
char *GeneratePass(int user_types, size_t num_char_types, size_t size)
{
	...
	if(pass != NULL)
	{
		...
		FillCharTypesArray(user_types, types); // fills an array with types generated by user
		// this array will be {0b1000, 0b0100, 0b0010, 0b0001} for "ulns" for example
		int randomtype = 0;
